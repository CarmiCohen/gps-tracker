# Data Storage & Files Mechanism (v8.9.37)
...
- **SIT Markers (Issue #194)**: Reconstructed from acknowledged logs to ensure zero-loss forensic parity. Now geographically anchored.
