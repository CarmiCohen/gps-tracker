# Documentation Organization & Forensic Audit Standard (v9.3.0)
...
- **STATUS/requirements_sot.md**: The definitive operational spec.
...
- **STATUS/compliance.md**: The **Verification & Compliance Manifest**. Formal proof of implementation and historical record.
- **STATUS/testing_status.md**: The backlog of pending unit tests, integration tests, and manual field validations.
...
3.  **SoT**: Update the core constants and requirements in `STATUS/requirements_sot.md`.
...
3.  Execute the **Verification Manifest** in **STATUS/compliance.md** and the **Backlog** in **STATUS/testing_status.md** against the current source code to ensure architectural standards are maintained.
