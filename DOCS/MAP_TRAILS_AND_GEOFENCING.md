...
- **Hindsight Correction**: Points promoted via the GtoEngine (Issue #415) are retroactively added to the trail to prevent "teleporting" visual artifacts.
...
- **SIT Markers**: Mechanical sitting events (SIT) are reconstructed on the map from synchronized forensic logs (Issue #412).
