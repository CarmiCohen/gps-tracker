# Video Streaming and CameraX Integration Documentation (v8.8.35)
...
---
*Note: Video streaming is not part of the v8.8.35 "Hardened Engine" specification. Legacy versioning fields have been purged from the system.*
