...
- **Position Health**: 10s (`GPS_UI_FAIL_THRESHOLD_MS`) staleness gate. Dims to "Ghost Mode" (Issue #338 - Formerly #193) if data is stale.
...
- **Vibration/Tilt**: Real-time orientation and shock monitoring (Issue #343 - Formerly #282).
...
- **Battery Drain**: Real-time current in mA (`currentMa`). (Issue #337 - Formerly #192)
- **Storage**: Binary indicator for Low/Critical disk space (50MB/10MB). (Issue #316 - Formerly #71)
