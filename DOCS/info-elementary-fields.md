...
*   **DEVICE STATE**: The current operational state of the tracker logic.
    ...
    *   `COOLING`: The device has exceeded `MAX_SAFE_TEMPERATURE_CELSIUS` (46.0°C) and is in power-save mode. (Issue #315 / Formerly #273)
...
These fields are primarily visualized in the **Analytical Ribbons** overlay and track mechanical "sitting" events. (Issue #336 / Formerly #282)
