# GPS Tracker - High-Assurance Forensic Tracking (v8.9.55)
...
- **Behavioral Sentinel**: Multi-sensor fusion for tamper detection, lift alerts, and chair-sit detection (Issue #459 / Formerly #336-E).
