...
*   **Deferred Service Recovery Authority (R626)**: On API 31+, background restoration requests MUST catch `ForegroundServiceStartNotAllowedException`. If restricted, the system MUST persist an `isRecoveryPending` flag. (Issue #626, July.30.26)
