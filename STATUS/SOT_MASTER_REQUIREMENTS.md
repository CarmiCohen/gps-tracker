...
*   **Background Resilience Health Check (R997)**: The system MUST provide a dedicated Diagnostics interface to monitor critical background permissions (Battery, Overlay, Alarms, Location) and hardware-specific states (Xiaomi MIUI permissions, Samsung Engine Tuning) to ensure tracking reliability. (Issue #059 / v9.3.11)
