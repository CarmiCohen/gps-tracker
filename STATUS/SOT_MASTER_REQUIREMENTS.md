# System Source of Truth (SoT) - July.25.10 (Flyweight Thread Safety & Native Latency Audit)
...
*   **Native Signal Latency (R580b)**: To maintain tick loop stability on budget hardware (e.g., Samsung A15), all JNI calls within the tracking hot-path MUST be monitored for execution latency. Native execution spikes exceeding 50ms MUST be logged as forensic warnings to prevent silent jitter in the 1Hz engine cycle. (Issue #580b, July.25.10)
