# Compliance & Operational Requirements (Audit Baseline) - v9.2.2
...
### 2.1. Hardening Phase Resolutions (v9.2.2)
...
### 2.2. Hardening Phase Resolutions (v9.1.2)
...
### 2.3. Hardening Phase Resolutions (v9.1.0)
