...
*   **FIXED Power Parity Consistency & evaluateAlarms Mismatch (#337)** - Resolution: Achieved absolute forensic parity for currentMa. (v8.9.5) (Formerly LEGACY_#192)
...
*   **FIXED Global Version Synchronization (LEGACY_#182)** - Resolution: Synchronized all source headers to v8.9.2. (v8.9.2)
...
*   **FIXED R917: Version Update Smoothness (#175)** - Resolution: Verified `MY_PACKAGE_REPLACED` handling. (Note: Initial baseline; superseded by Issue #317). (8.8.36)
*   **FIXED R867: Default Identity Verification (#174)** - Resolution: Standardized default IDs to "T" and "V" as per final R182 mandate. (Supersedes intermediate "Ttk/Cohen" baseline). (8.8.36)
...
*   **FIXED R916: Settings Configuration Verification (#302)** - Resolution: Removed role-based UI gating. (Formerly LEGACY_#432 / #30)
*   **FIXED R933: Alert Grace Period (#301)** - Resolution: Implemented 2s grace period. (Formerly LEGACY_#431 / #29)
...
*   **FIXED Redundant Tamper/SIT Alerting (#310)** - Resolution: Decoupled SIT alerting from general tamper flag. (Formerly LEGACY_#285 / #83)
...
*   **FIXED Storage Integrity Monitoring (#316)** - Resolution: Implemented LOW and CRITICAL storage thresholds. (Formerly LEGACY_#273 / #71)
...
*   **FIXED R917: Update Smoothness (#317)** - Resolution: Verified update recovery infrastructure. (Formerly LEGACY_#400 / #300 / #28)
...
*   **FIXED Timing Integrity Leakage (:app layer) (#221)** - Resolution: Migrated to SystemClock.elapsedRealtime(). (Formerly LEGACY_#311 / LEGACY_#285 / #13)
