# System Source of Truth (SoT) - v8.9.40
...
*   **Engine Identity**: The system operates on the v8.9.40 baseline logic.
...
*   **R851a [Superseded]**: Previously restored Tracker role to Green (Lime 500). Replaced by R865 authoritative branding.
*   **R815 [Superseded]**: Legacy Role Identity Color swap (Teal). Replaced by R851a.
...
*   **R832: Chair Sit Detection Engine**: Multi-sensor fusion logic in `:core:engine` using tilt, vibration, and barometric plunge thresholds to detect chair occupancy.
