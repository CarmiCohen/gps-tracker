...
5.  **Signaling Provider Abstraction**: (New) Simplify `CommunicationManager` by delegating transport-specific configuration to a `SignalingTransportFactory`, allowing the core manager to remain transport-agnostic and reducing the risk of hard-coded transport regressions like #906.
