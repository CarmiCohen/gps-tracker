...
| :--- | :--- | :--- |
| **#018** | **Stationary Anchor Hard-Lock** | Jitter in stationary GPS fixes causes erroneous distance accumulation and map clutter. Implement coordinate clamping logic. |
