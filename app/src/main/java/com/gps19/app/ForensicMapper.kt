...
/**
 * ForensicMapper: Unified mapping utility for high-frequency telemetry metadata.
 * Aug.20.07:
 * - Issue #225 consolidation: Centralized 1:1 parity transformation for 
 *   forensic metadata across persistence, engine, and UI models.
 */
object ForensicMapper {

    /**
     * Maps forensic fields from EngineConnectionPoint to ConnectionPoint.
     */
