 ...
 *   fully decomposed primitive parameters instead of monolithic MainUiState 
 *   and DiagnosticState. This prevents high-frequency telemetry recomposition 
 *   stalls on budget hardware (Samsung A15).
 */
