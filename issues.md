# Project Issues & Hardening Tracking (Aug.26.10)
...
*   **Issue #735**: **Setup Overlay Modal Block**. The `PhoneSetupOverlay` blocks service startup until "Battery Unrestricted" and "Appear on Top" permissions are manually configured. It lacks a bypass for testing or non-standard configurations, potentially stalling automated soak tests.
...
---
*For older resolutions, see [RESOLUTION_ARCHIVE.md](STATUS/RESOLUTION_ARCHIVE.md). (vAug.26.10)
