# Project Issues & Hardening Tracking (Sep.05.16)
...
- **Current Audit Baseline: [SOT: 266 (Rules: 44, IDs: 223), Resolved: 892, Open: 1 (#916), Testing: 1 (Sub-items: 12), Ideas: 7, QA: 242]**

*For older resolutions, see [RESOLUTION_ARCHIVE.md](STATUS/RESOLUTION_ARCHIVE.md). (vSep.05.16)*
