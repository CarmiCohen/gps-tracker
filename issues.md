# Project Issues & Hardening Tracking (Sep.08.00)
...
*   **Issue #935 Hardening**: Add monotonic `rt` field to `RealtimeStatus` Protobuf and `TelemetryProtobufMapper`. Eliminates heuristic drift in remote signaling to resolve HUD "Red-Lock" false positives.
...
*For older resolutions, see [RESOLUTION_ARCHIVE.md](STATUS/RESOLUTION_ARCHIVE.md). (vSep.08.00)*
